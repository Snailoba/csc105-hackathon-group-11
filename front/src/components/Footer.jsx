...
function Footer() {
  ...
  return (
    <Box sx={footer}>
      <Box sx={createCon}>
        <Button sx={createButton} onClick={handleClickSubmit}>Create your recipe</Button>
      </Box>
      <Box sx={aboutCon}>
        <Box sx={left}>
        ...
        <Typography sx={aboutDesc}>
          Blu personifies the tastes and preferences of individuals 
          ...
          that evoke a sense of relaxation and culinary bliss.</Typography>
      </Box>
    </Box>
  );
}
